<div class="max-w-7xl mx-auto px-4 py-24">
  <h1 class="text-4xl font-bold text-[#160D51] mb-12 text-center">Pier Closure Information</h1>
  ...
  <div class="max-w-6xl mx-auto space-y-12">
    ...
    <section>
      <h2 class="text-3xl font-bold text-[#160D51] mb-6">Current Progress</h2>
      <div class="prose prose-lg max-w-none">
        <p>The Council has:</p>
        <ul>
          <li>Received and published detailed structural surveys</li>
          <li>Secured Listed Building Consent for repairs</li>
          <li>Appointed expert contractors for investigation works</li>
          <li>Committed £3 million to initial repair works</li>
          <li>Engaged with various stakeholders including the National Piers Society</li>
        </ul>
      </div>
    </section>

    <section>
      <h2 class="text-3xl font-bold text-[#160D51] mb-6">Structural Surveys</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div class="bg-white/80 p-8 rounded-2xl shadow-lg border border-[#160D51]/10">
          <h3 class="text-2xl font-bold text-[#160D51] mb-4">Available Reports</h3>
          <ul class="space-y-4">
            <li>
              <a 
              ...
              >
                ...
                Southport Pier Decking Report (859KB)
              </a>
            </li>
            <li>
              <a 
              ...
              >
                ...
                Southport Pier Steelwork Report (5.77MB)
              </a>
            </li>
            <li>
              <a 
            ...
            <li>
              ...
              >
                ...
                May 2024 Final Report (10.13MB)
              </a>
            </li>
          </ul>
        </div>
        <div class="bg-white/80 p-8 rounded-2xl shadow-lg border border-[#160D51]/10">
          <h3 class="text-2xl font-bold text-[#160D51] mb-4">Survey Findings</h3>
          <ul class="space-y-3 text-gray-700">
            <li>• Poor repairs from 2000-2002 using incorrect materials</li>
            <li>• Incorrect installation of noggins causing deck instability</li>
            <li>• Steelwork delamination due to improper edge preparation</li>
            <li>• Water traps causing pooling of salt-laden water</li>
            <li>• Severe decay affecting over 25% of decking</li>
            <li>• Inadequate surface preparation for recoating works</li>
          </ul>
        </div>
      </div>
      <div class="bg-[#160D51]/5 p-8 rounded-2xl">
        <p class="text-gray-700">The surveys were conducted by Thomasons Consulting Civil and Structural Engineers, leading experts in complex civil & structural engineering. Their findings have been instrumental in determining both the extent of work needed and the approach required for a successful restoration.</p>
      </div>
    </section>
